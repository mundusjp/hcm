...
<div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
          <h6 class="slim-pagetitle">Peringatkan Officer</h6>
        </div><!-- slim-pageheader -->
        <div class="section-wrapper">
          <form action="{{route('deputy-vice-president.peringatkan',$program->id)}}" method="post">
          @method('PATCH')
          {{ csrf_field() }}
          <div class="form-layout">
            ...
            <div class="form-layout-footer">
              ...
              <button type="submit" class="btn btn-outline-warning">Peringatkan</button><br><br>
              </form>
