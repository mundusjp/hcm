		...
		<div class="container">
			...
			<div class="company-contact">
				<div class="phone left">
					...
					<a href="tel:{{$company->no_telp}}">{{$company->no_telp}}</a>
		...
		<div class="container">
			<div class="details clearfix">
				...
				<div class="data right">
					<div class="title">Log Mingguan</div>
					<div class="date">
						<p><strong style="font-weight:600;">Tanggal percetakan:</strong> {{Carbon\Carbon::now()->format('Y-m-d')}}</p>
						<p><strong style="font-weight:600;">Untuk Minggu Ke-&nbsp;&nbsp;&nbsp;:</strong>&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp; {{Carbon\Carbon::now()->weekOfYear}}</p>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						...
						<th class="desc" style="text-align:left;">Log</th>
				...
				<tbody>
					<?php $i=0; ?>
						...
						for($j=1;$j<6;$j++){
								$query =
								"<tr>
									<th colspan=\"6\"><h3>".$list_hari[$j]."</h3></th>
								</tr>
								";
								echo $query;
							?>
