                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Logbook - Officer</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">List Officer</strong>
                </div>
                <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-outline-warning" href="{{route('superadmin.log.harian.officer',$user->id)}}">Harian</a></td>
                            <td><a class="btn btn-outline-warning" href="{{route('superadmin.log.mingguan.officer',$user->id)}}">Mingguan</a></td>
                            <td><a class="btn btn-outline-warning" href="{{route('superadmin.log.bulanan.officer',$user->id)}}">Bulanan</a></td>
                        </tr>
                        @endforeach
